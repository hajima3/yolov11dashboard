...
PROCESS_EVERY_N_FRAMES = 1  # Process every frame for smooth webcam
...
SCALE_FACTOR = 0.6  # Slightly better quality for webcam
...
JPEG_QUALITY = 75  # Better quality for webcam streaming
